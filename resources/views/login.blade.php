  ...
  <div class="flex items-center justify-center min-h-screen">
    <div class="w-full max-w-4xl bg-white shadow-lg rounded-2xl overflow-hidden flex">
      ...
      <div class="w-1/2 p-8 flex flex-col justify-center">
        ...
        <p class="text-sm text-gray-600 mb-6">Login to your account to continue</p>
        ...
        <form method="POST" action="{{ route('login') }}">
          @csrf
          <input type="text" name="username" placeholder="Username" class="w-full mb-4 px-4 py-2 rounded-full bg-green-100 placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-amber-400"/>
